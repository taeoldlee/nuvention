            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div>
                    <p className="text-xs text-muted font-body uppercase tracking-wide mb-0.5">Matches</p>
          ...
          <section>
              ...
              <h2 className="font-display text-xl font-semibold text-dark">
                ...
                {applications.length > 0 && (
                  <span className="text-muted font-normal text-base ml-2">
                    ({pendingApps.length} new{actionedApps.length > 0 ? `, ${actionedApps.length} reviewed` : ''})
                  </span>
                )}
              </h2>
            </div>
            ...
            {applications.length === 0 ? (
              <div className="card text-center py-12">
                ...
                <h3 className="font-display text-lg font-semibold text-dark mb-2">No matches yet</h3>
                <p className="text-muted text-sm font-body max-w-sm mx-auto">
                  {brief.status === 'OPEN'
                    ? 'Your brief is live. Matched creators will appear here shortly.'
                    : 'This brief is not currently active.'}
                </p>
              </div>
            ) : (
              <>
