...
async function main() {
  ...
  await prisma.creator.createMany({
    data: [
      // ── Nano tier (1K–5K followers) ──
      {
        ...
        followerCount: 2800,
        engagementRate: 8.2,
        audienceGeography: { "Evanston": 45, "Chicago": 35, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 40, "25-34": 35, "35-44": 25 }, genderBreakdown: { female: 55, male: 45 } },
        contentStyleTags: ["Food Photography", "Cozy Vibes", "Behind the Scenes"],
        portfolioUrls: ["https://shauryaeats.com/portfolio"],
        topPostUrls: ["https://instagram.com/p/example1", "https://instagram.com/p/example2"],
        bio: 'Northwestern student documenting Evanston\'s food scene one bowl at a time. Specializes in warm, inviting food photography.',
        contactEmail: 'shaurya@example.com',
      ...
      },
      {
        ...
        followerCount: 4200,
        engagementRate: 9.1,
        audienceGeography: { "Evanston": 30, "Chicago": 50, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 55, "25-34": 30, "35-44": 15 }, genderBreakdown: { female: 65, male: 35 } },
        contentStyleTags: ["Trendy", "Quick Cuts", "POV Content"],
        portfolioUrls: ["https://tiktok.com/@kate.creates"],
        topPostUrls: ["https://tiktok.com/@kate.creates/video/1"],
        bio: 'TikTok creator making snappy food and lifestyle content. Known for POV-style restaurant visits that go viral.',
        contactEmail: 'katelyn@example.com',
        neighborhoods: ["Evanston", "Wicker Park"],
        city: 'Evanston',
        state: 'IL',
      ...
      },
      {
        ...
        followerCount: 3100,
        engagementRate: 7.5,
        audienceGeography: { "Hyde Park": 40, "Chicago": 40, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 30, "25-34": 45, "35-44": 25 }, genderBreakdown: { female: 60, male: 40 } },
        contentStyleTags: ["Minimalist", "Clean Aesthetic", "Flat Lay"],
        portfolioUrls: ["https://nadiastastes.com"],
        topPostUrls: ["https://instagram.com/p/nadia1"],
        bio: 'UChicago grad with a love for minimalist food photography. Clean, editorial aesthetic that highlights textures and colors.',
        contactEmail: 'nadia@example.com',
        neighborhoods: ["Hyde Park", "Kenwood"],
        city: 'Chicago',
        state: 'IL',
        profilePhotoUrl: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=150',
      },
      {
        name: 'Tyler Kim',
        handle: '@tyler.bites',
        ...
        followerCount: 1500,
        engagementRate: 11.3,
        audienceGeography: { "Logan Square": 35, "Chicago": 45, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 60, "25-34": 30, "35-44": 10 }, genderBreakdown: { female: 50, male: 50 } },
        contentStyleTags: ["Raw & Authentic", "Street Food", "ASMR"],
        portfolioUrls: ["https://tiktok.com/@tyler.bites"],
        topPostUrls: ["https://tiktok.com/@tyler.bites/video/1"],
        bio: 'Street food enthusiast making ASMR and raw, unfiltered food content. Super engaged micro community in Logan Square.',
        contactEmail: 'tyler@example.com',
        neighborhoods: ["Logan Square", "Humboldt Park"],
        city: 'Chicago',
        state: 'IL',
        profilePhotoUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150',
      },
      // ── Micro tier (5K–50K followers) ──
      {
        name: 'Jin Park',
        handle: '@jin.eats.chi',
        platform: 'INSTAGRAM',
        followerCount: 12000,
        engagementRate: 5.4,
        audienceGeography: { "Chicago": 60, "Evanston": 20, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 25, "25-34": 45, "35-44": 30 }, genderBreakdown: { female: 50, male: 50 } },
        contentStyleTags: ["Editorial", "Storytelling", "Cultural Deep Dives"],
        portfolioUrls: ["https://jineatschi.com", "https://instagram.com/jin.eats.chi"],
        topPostUrls: ["https://instagram.com/p/jin1", "https://instagram.com/p/jin2"],
        bio: 'Korean-American food writer and photographer exploring Chicago\'s diverse culinary landscape. Editorial style with cultural storytelling.',
        contactEmail: 'jin@example.com',
        neighborhoods: ["West Loop", "Wicker Park", "Evanston"],
        city: 'Chicago',
        state: 'IL',
        profilePhotoUrl: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=150',
      },
      {
        name: 'Ava Martinez',
        handle: '@ava.foodie',
        ...
        followerCount: 18500,
        engagementRate: 4.8,
        audienceGeography: { "Wicker Park": 25, "Chicago": 55, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 20, "25-34": 50, "35-44": 30 }, genderBreakdown: { female: 70, male: 30 } },
        contentStyleTags: ["Aesthetic", "Brunch Culture", "Lifestyle"],
        portfolioUrls: ["https://avafoodie.com"],
        topPostUrls: ["https://instagram.com/p/ava1", "https://instagram.com/p/ava2"],
        bio: 'Brunch queen of Wicker Park. Lifestyle and food content with a warm, aspirational aesthetic. Brand partnerships with 20+ Chicago restaurants.',
      ...
      {
        name: 'Marcus Johnson',
        handle: '@marcus.j.eats',
        platform: 'YOUTUBE',
        followerCount: 28000,
        engagementRate: 3.9,
        audienceGeography: { "Chicago": 50, "Midwest": 30, "National": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 15, "25-34": 40, "35-44": 35, "45+": 10 }, genderBreakdown: { female: 40, male: 60 } },
        contentStyleTags: ["Video Reviews", "Cinematic", "Long-Form"],
        portfolioUrls: ["https://youtube.com/@marcusjeats"],
        topPostUrls: ["https://youtube.com/watch?v=marcus1"],
        bio: 'Chicago food YouTuber with cinematic restaurant reviews. Known for in-depth, beautifully shot long-form content.',
        contactEmail: 'marcus@example.com',
        neighborhoods: ["West Loop", "Hyde Park", "Logan Square"],
        city: 'Chicago',
        state: 'IL',
      ...
      },
      {
        ...
        followerCount: 9500,
        engagementRate: 6.1,
        audienceGeography: { "Evanston": 40, "Chicago": 40, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 35, "25-34": 40, "35-44": 25 }, genderBreakdown: { female: 60, male: 40 } },
        contentStyleTags: ["Warm Tones", "Community Focused", "Behind the Scenes"],
        portfolioUrls: ["https://danidishes.com"],
        topPostUrls: ["https://instagram.com/p/dani1"],
        bio: 'Community-focused food creator in Evanston. Loves highlighting local businesses and the people behind the food.',
        contactEmail: 'dani@example.com',
        neighborhoods: ["Evanston", "Rogers Park"],
        city: 'Evanston',
        state: 'IL',
      ...
      {
        name: 'Lucy Chen',
        handle: '@lucy.chi.eats',
        platform: 'REDNOTE',
        followerCount: 15000,
        engagementRate: 5.7,
        audienceGeography: { "Chicago": 45, "US Chinese Community": 35, "International": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 45, "25-34": 40, "35-44": 15 }, genderBreakdown: { female: 65, male: 35 } },
        contentStyleTags: ["Bilingual", "Asian Cuisine", "Aesthetic"],
        portfolioUrls: ["https://xiaohongshu.com/lucy"],
        topPostUrls: ["https://xiaohongshu.com/lucy/post1"],
        bio: 'Bilingual (EN/ZH) food creator on RedNote. Bridges Asian and American food culture with stunning visual content.',
        contactEmail: 'lucy@example.com',
        neighborhoods: ["Chinatown", "West Loop", "Evanston"],
        city: 'Chicago',
        state: 'IL',
      ...
      },
      {
        ...
        followerCount: 7800,
        engagementRate: 5.9,
        audienceGeography: { "Logan Square": 30, "Chicago": 50, "Other IL": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 20, "25-34": 45, "35-44": 35 }, genderBreakdown: { female: 45, male: 55 } },
        contentStyleTags: ["Craft Beverages", "Bar Scene", "Moody Aesthetic"],
        portfolioUrls: ["https://miketeats.com"],
        topPostUrls: ["https://instagram.com/p/mike1"],
        bio: 'Craft beverage and bar scene photographer. Moody, atmospheric shots of cocktails, coffee, and the spaces that serve them.',
      ...
      {
        name: 'Emma Walsh',
        handle: '@emma.evanston',
        platform: 'INSTAGRAM',
        followerCount: 6200,
        engagementRate: 7.3,
        audienceGeography: { "Evanston": 55, "Chicago North Shore": 30, "Other IL": 15 },
        audienceDemographics: { ageBreakdown: { "25-34": 35, "35-44": 40, "45+": 25 }, genderBreakdown: { female: 75, male: 25 } },
        contentStyleTags: ["Family Friendly", "Local Guide", "Warm & Inviting"],
        portfolioUrls: ["https://emmaevanston.com"],
        topPostUrls: ["https://instagram.com/p/emma1"],
        bio: 'Evanston mom and local dining guide. Family-friendly restaurant content with a warm, inviting aesthetic.',
      ...
      },
      {
        ...
        followerCount: 22000,
        engagementRate: 6.8,
        audienceGeography: { "Chicago": 55, "Midwest": 25, "National": 20 },
        audienceDemographics: { ageBreakdown: { "18-24": 50, "25-34": 35, "35-44": 15 }, genderBreakdown: { female: 60, male: 40 } },
        contentStyleTags: ["Viral Trends", "Quick Reviews", "Energetic"],
        portfolioUrls: ["https://tiktok.com/@priya.plates"],
        topPostUrls: ["https://tiktok.com/@priya.plates/video/1", "https://tiktok.com/@priya.plates/video/2"],
        bio: 'High-energy TikTok food reviewer. Known for honest, quick-take restaurant reviews that regularly hit 100K+ views.',
        contactEmail: 'priya@example.com',
        neighborhoods: ["West Loop", "Wicker Park", "Logan Square"],
        city: 'Chicago',
        state: 'IL',
        profilePhotoUrl: 'https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=150',
      },
      // ── Mid tier (50K–200K followers) ──
      {
        ...
        followerCount: 85000,
        engagementRate: 3.2,
        audienceGeography: { "Chicago": 40, "Midwest": 30, "National": 30 },
        audienceDemographics: { ageBreakdown: { "18-24": 25, "25-34": 45, "35-44": 25, "45+": 5 }, genderBreakdown: { female: 65, male: 35 } },
        contentStyleTags: ["Premium Dining", "Editorial", "Brand Partnerships"],
        portfolioUrls: ["https://riaeats.com", "https://instagram.com/ria.eats"],
        topPostUrls: ["https://instagram.com/p/ria1", "https://instagram.com/p/ria2"],
        bio: 'Chicago\'s go-to food influencer for premium dining content. Editorial quality with strong brand partnership experience.',
        contactEmail: 'ria@example.com',
        neighborhoods: ["West Loop", "Gold Coast", "River North"],
        city: 'Chicago',
        state: 'IL',
        profilePhotoUrl: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=150',
      },
      {
        name: 'Sam Brooks',
        handle: '@sam.brooks',
        ...
        followerCount: 62000,
        engagementRate: 4.1,
        audienceGeography: { "Chicago": 35, "Midwest": 30, "National": 35 },
        audienceDemographics: { ageBreakdown: { "18-24": 20, "25-34": 40, "35-44": 30, "45+": 10 }, genderBreakdown: { female: 45, male: 55 } },
        contentStyleTags: ["Documentary Style", "Cinematic", "Chef Interviews"],
        portfolioUrls: ["https://youtube.com/@sambrooks"],
        topPostUrls: ["https://youtube.com/watch?v=sam1"],
        bio: 'Documentary-style food YouTuber. In-depth chef interviews and kitchen stories with cinematic production quality.',
        contactEmail: 'sam@example.com',
        neighborhoods: ["West Loop", "Logan Square", "Pilsen"],
        city: 'Chicago',
        state: 'IL',
        profilePhotoUrl: 'https://images.unsplash.com/photo-1463453091185-61582044d556?w=150',
      },
      {
        name: 'Sofia Reyes',
        handle: '@sofia.sabor',
        ...
        followerCount: 55000,
        engagementRate: 3.5,
        audienceGeography: { "Chicago": 45, "Midwest": 25, "National": 30 },
        audienceDemographics: { ageBreakdown: { "18-24": 15, "25-34": 40, "35-44": 35, "45+": 10 }, genderBreakdown: { female: 55, male: 45 } },
        contentStyleTags: ["Food Blog", "Recipe Development", "Cultural Heritage"],
        portfolioUrls: ["https://sofiasabor.com", "https://substack.com/@sofiasabor"],
        topPostUrls: ["https://sofiasabor.com/best-of-2025"],
        bio: 'Multi-platform food blogger and recipe developer. Specializes in Latin American cuisine and cultural food storytelling.',
        contactEmail: 'sofia@example.com',
        neighborhoods: ["Pilsen", "Logan Square", "West Loop"],
        city: 'Chicago',
        state: 'IL',
  ...
  console.log('  15 creators (4 nano, 8 micro, 3 mid)');
  console.log('\nDemo accounts:');
